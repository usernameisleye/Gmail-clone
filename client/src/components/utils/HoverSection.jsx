...
const HoverSection = ({ mail, isRead }) => {
    ...
    return ( 
        <div className={`${ isRead ? "bg-Read-Bg" : "bg-White" } text-FA-Dark absolute top-0 bottom-0 right-0 flex justify-evenly items-center w-1/5 invisible group-hover:visible`}>
